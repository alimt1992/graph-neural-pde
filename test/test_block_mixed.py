...
class MixedODEBlockTests(unittest.TestCase):
  def setUp(self):
    ...
    opt = {'dataset': 'Cora', 'self_loop_weight': 1, 'leaky_relu_slope': 0.2, 'beta_dim': 'sc', 'heads': 2,
           ...
           'batch_size': 1, 'multi_modal': False, 'total_deriv': None, 'directional_penalty': None,
           'jacobian_norm2': None, 'step_size':1, 'max_iter': 10, 'beltrami': False}
    self.opt = {**OPT, **opt}
...
if __name__ == '__main__':
  ...
  tests.test_get_mixed_attention()
