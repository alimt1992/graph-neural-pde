...
class GNNTests(unittest.TestCase):
  def setUp(self):
    ...
    opt = {'dataset': 'Cora', 'self_loop_weight': 1, 'leaky_relu_slope': 0.2, 'beta_dim': 'vc', 'heads': 2, 'K': 10,
           ...
           'augment': False, 'adjoint': False, 'tol_scale': 1, 'time': 1, 'ode': 'ode', 'input_dropout': 0.5, 'dropout': 0.5,
           'method': 'euler', 'block': 'constant', 'function': 'laplacian', 'rewiring': None, 'no_alpha_sigmoid': False,
